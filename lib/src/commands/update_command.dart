...
/// Refreshes generated files against the templates of the running moarch
/// version.
///
...
///
/// Every generated file is addressable on its own (`moarch update validation`)
/// or by group (`moarch update core`); with no arguments the whole project is
/// considered. Files the project never generated are never added — `update`
/// refreshes what is there, it does not scaffold.
